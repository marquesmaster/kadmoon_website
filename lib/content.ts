  ...
  columns: [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Power Apps by city', href: '/power-apps-development' },
        { label: 'Azure data engineering', href: '/azure-data-engineering' },
        { label: 'Microsoft Copilot by city', href: '/copilot-consulting' },
        { label: 'Data governance by city', href: '/data-governance' },
