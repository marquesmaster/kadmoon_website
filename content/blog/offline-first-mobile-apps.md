...
Common strategies, from simplest to most robust:
...
Real networks are worse than a clean on/off switch. They drop mid-request, return slowly, or claim to be connected while passing no data. Offline-first apps have to treat every network interaction as something that might fail halfway.
