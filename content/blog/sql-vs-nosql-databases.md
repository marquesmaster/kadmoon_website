...
Relational databases give you ACID transactions: a group of changes either all succeed or all fail, and the data is never left half-updated. If you are moving money, adjusting inventory, or filing something with a regulator, that guarantee is the reason the database exists.
