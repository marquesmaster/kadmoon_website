...
description: "Software engagement models compared: fixed-scope projects, dedicated teams, staff augmentation, discovery-then-build, and retainers, and how to match one to your needs."
...
The stakes are real money. A McKinsey and University of Oxford study of over 5,400 IT projects found that [large IT projects ran 45% over budget and delivered 56% less value than predicted](https://www.mckinsey.com/capabilities/tech-and-ai/our-insights/delivering-large-scale-it-projects-on-time-on-budget-and-on-value), with 17% failing badly enough to threaten the company. Much of that damage traces back to a mismatch between how the work was structured and how much the requirements actually changed. The market has plenty of options to choose from: the [global IT services outsourcing market was worth roughly 745 billion dollars in 2024](https://www.grandviewresearch.com/industry-analysis/it-services-outsourcing-market) and is forecast to reach 1.22 trillion by 2030. This is a practical comparison of the common software engagement models and how to match one to your situation.
...
This model shines when the work is ongoing, evolving, or too uncertain to pin down up front. Instead of negotiating every change, you reprioritize the backlog as you learn. The team accumulates deep knowledge of your product and domain, which makes them faster over time. That compounding familiarity is part of why the outsourcing market is [growing at roughly 8.6% a year through 2030](https://www.grandviewresearch.com/industry-analysis/it-services-outsourcing-market): buyers are shifting away from one-off builds toward standing capacity that sticks with a product across releases. It suits companies building and growing a platform rather than delivering a one-off. The trade-off is that you take on more of the direction. A dedicated team is only as productive as the priorities you feed it, so you need someone engaged in [sprint planning](/blog/sprint-planning-for-clients) to keep it pointed the right way. The economics over a multi-phase roadmap often favor this model, as our look at [dedicated team vs fixed project](/blog/dedicated-team-vs-fixed-project-cost) explains.
...
Many real engagements combine these: discovery to define the work, a dedicated team to build it, a retainer to maintain it. Given how much value large projects tend to lose when structure and reality diverge, what matters is choosing deliberately rather than defaulting to whatever the firm proposes first. For help picking a model, see [how to choose a software partner](/#how-to-choose) or [get a technical proposal](/#contact).
